javascript:(function() {
  ...
  for (var i = 0; i < blacklist.length; i++) {
    if (currentURL.indexOf(blacklist[i]) !== -1) {
      javascript:(function() {  var toastContainer = document.createElement('div');  toastContainer.style.position = 'fixed';  toastContainer.style.bottom = '10px';  toastContainer.style.left = '10px';  toastContainer.style.width = '300px';  toastContainer.style.padding = '10px';  toastContainer.style.backgroundColor = '#333';  toastContainer.style.color = '#fff';  toastContainer.style.fontFamily = 'Arial, sans-serif';  toastContainer.style.fontSize = '16px';  toastContainer.style.boxShadow = '0 2px 5px rgba(0, 0, 0, 0.3)';  toastContainer.style.transition = 'transform 0.3s ease';  toastContainer.style.transform = 'translateX(350px)';  toastContainer.style.zIndex = '99999999999999';    var toastMessage = document.createTextNode('Sorry! Broken.');    toastContainer.appendChild(toastMessage);    document.body.appendChild(toastContainer);    setTimeout(function() {    toastContainer.style.transform = 'translateX(0)';  }, 100);    setTimeout(function() {    toastContainer.style.transform = 'translateX(350px)';    setTimeout(function() {      document.body.removeChild(toastContainer);    }, 300);  }, 3000);})();
      return;
    }
  }
